...
#[cfg(test)]
mod tests {
    use super::{LongMemEvalKiokuMetricInput, build_metrics};
    ...
    fn longmemeval_kioku_metrics_split_main_and_abstention_scores() {
        ...
        assert_eq!(
            metrics.metrics.per_type_answer_accuracy["multi-session"].accuracy,
            1.0
        );
    }
}
